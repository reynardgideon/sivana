...
$judul = 'PESERTA ' . strtoupper($pelatihan) . ' DI ' . strtoupper($pod->display('lokasi')) . ' YANG DINYATAKAN TIDAK LULUS DAN PERLU MENGULANG PELATIHAN';
...
<body>
    <div class="page" id="page">
        <div class="columns mt-3">
            ...
            <div class="column is-5" style="line-height:18px; color: #000; margin-bottom:30px;"><span id="lampiran">Lampiran III</span><br />
        ...
        <div class="has-text-left mt-2" style="line-height:20px;">
            <table style="width:100%; margin-bottom: 5px;">
                ...
                <?php $i = 1; ?>
                <?php foreach ((array) $tl['Mengulang Pelatihan'] as $obj): ?>
                    <tr>
    ...
    <div id="edit_modal" class="modal" style="padding-top:0px;">
        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                ...
                <div class="control">
                    <input class="input" type="text" value="Lampiran III" name="lampiran">
