                                            ...
                                            switch ($_GET['action']) {
                                                case 'tambah':
                                                    if (isset($_GET['editor']) && $_GET['editor'] == 'bulk') {
                                                        editor_bulk('pengguna', null);
                                                    } else {
                                                        editor_single('pengguna', null, null);
                                                    }
                                                    break;
                                                case 'ubah':
                                                    editor_single('pengguna', $_GET['id_pengguna'], null);
                                                    break;
                                            }
                                        } else {
                                            halaman_pengguna();
