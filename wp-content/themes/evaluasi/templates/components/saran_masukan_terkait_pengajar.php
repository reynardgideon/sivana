...
function page_saran_masukan_terkait_pengajar()
{
                    ...
                    <div id="form_saran">
                        <form id="update_saran">
                            ...
                            <div class="form-check ml-4">
                                ...
                                <label class="form-check-label" for="matriks_rekomendasi">
                                    Matriks Rekomendasi
                                </label>
                            </div>
                            ...
                            <input type="hidden" name="kategori" value="pengajar">
                        </form>
                    </div>
                </div>
                <div class="modal-footer" id="modalButtons">
                ...
                if (checked_ids.length == 0) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.matriks_rekomendasi == 0) {
