...
$judul = 'PESERTA ' . strtoupper($pelatihan) . ' DI ' . strtoupper($pod->display('lokasi')) . ' YANG DINYATAKAN LULUS';
...
<body>
    <div class="page" id="page">
        <div class="columns mt-3">
            ...
            <div class="column is-5" style="line-height:18px; color: #000; margin-bottom:30px;"><span id="lampiran">Lampiran I</span><br />
        ...
        <div class="has-text-left mt-1" style="line-height:20px;">
            <table style="width:100%; margin-bottom: 5px;">
                ...
                <?php $i = 1; ?>
                <?php foreach ((array) $hasil['lulus'] as $nip => $p) : ?>
                    <tr>
                        <?php $peserta = pods('user', array('limit' => 1, 'where' => "nip.meta_value ='" . $nip . "'")); ?>
    ...
    <div id="edit_modal" class="modal" style="padding-top:0px;">
        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                ...
                <div class="control">
                    <input class="input" type="text" value="Lampiran I" name="lampiran">
